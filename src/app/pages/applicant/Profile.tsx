        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="font-['Source_Serif_4',serif] text-[#6c6c6c] text-lg tracking-[-0.3px] mt-2">
              Basic information about you. Changes are saved automatically.
            </p>
          </div>
          {/* Autosave indicator */}
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div>
            ...
            <input
              className={cn(fieldCls, isFieldError("first_name") ? "border-red-400" : "border-[#dbe0ec]", isSubmitted && "opacity-60 cursor-not-allowed")}
            ...
            {isFieldError("first_name") && (
              <p className="font-['Geist_Mono',monospace] text-[10px] text-red-500 mt-1">Required</p>
            )}
          </div>
          <div>
            <label className={labelCls}>Last Name <span className="text-red-500">*</span></label>
            <input
              className={cn(fieldCls, isFieldError("last_name") ? "border-red-400" : "border-[#dbe0ec]", isSubmitted && "opacity-60 cursor-not-allowed")}
          ...
          <div>
            ...
            <input
              className={fieldCls + " border-[#dbe0ec] opacity-60 cursor-not-allowed"}
              type="email"
              value={profile?.email || ""}
              disabled
            />
          ...
          <div>
            <label className={labelCls}>Current Grade <span className="text-red-500">*</span></label>
            <select
              className={cn(selectCls, isFieldError("grade") ? "border-red-400" : "", isSubmitted && "opacity-60 cursor-not-allowed")}
              value={form.grade}
